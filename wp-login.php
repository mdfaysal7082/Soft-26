...
<link rel="stylesheet" id="login-css" href="./wp-admin/css/login.min.css?ver=6.1.1" media="all">
	...
	<link rel="icon" href="./wp-content/uploads/2018/06/cropped-eggs-32x32.jpg" sizes="32x32">
<link rel="icon" href="./wp-content/uploads/2018/06/cropped-eggs-192x192.jpg" sizes="192x192">
<link rel="apple-touch-icon" href="./wp-content/uploads/2018/06/cropped-eggs-180x180.jpg">
<meta name="msapplication-TileImage" content="./wp-content/uploads/2018/06/cropped-eggs-270x270.jpg">
	</head>
	...
	<script type="text/javascript">document.body.className = document.body.className.replace('no-js','js');</script>
		...
		<form name="loginform" id="loginform" action="http://localhost/assignment-26/wp-login.php" method="post">
			<p>
			...
			<p class="submit">
				<input type="submit" name="wp-submit" id="wp-submit" class="button button-primary button-large" value="Log In">
									<input type="hidden" name="redirect_to" value="http://localhost/assignment-26/wp-admin/">
									<input type="hidden" name="testcookie" value="1">
			</p>
		</form>

					<p id="nav">
				<a href="./my-account-2/lost-password/index.html">Lost your password?</a>			</p>
...
<script id="wp-util-js-extra">var _wpUtilSettings = {"ajax":{"url":"\/assignment-26\/wp-admin\/admin-ajax.php"}};</script>
<script src="./wp-includes/js/wp-util.min.js?ver=6.1.1" id="wp-util-js"></script>
<script id="user-profile-js-extra">var userProfileL10n = {"user_id":"0","nonce":"8673d64c30"};</script>
